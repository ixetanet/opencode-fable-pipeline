---
description: FALLBACK planner tier 1 (GPT 5.6 Sol via OpenAI subscription) - used only when the Fable planner errors or refuses (guardrail trigger). Body is a byte mirror of planner.md - regenerate after editing planner.md.
mode: subagent
