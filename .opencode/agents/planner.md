---
description: Produces the implementation plan and the per-task review strategy (premium Fable 5 - the orchestrator calls this at most twice per run). Read-only except .pipeline/.
mode: subagent
