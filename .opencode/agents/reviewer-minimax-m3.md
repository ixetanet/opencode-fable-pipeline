---
description: General diff reviewer on MiniMax M3 - angle and rubric are assigned per-task by the plan's review strategy. Cheapest pass; suited to mechanical rubrics. Read-only.
mode: subagent
