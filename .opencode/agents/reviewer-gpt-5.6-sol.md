---
description: Primary diff reviewer on GPT 5.6 Sol (OpenAI subscription - zero marginal cost) - runs every selected catalog angle; angle and rubric assigned per-task. Read-only.
mode: subagent
